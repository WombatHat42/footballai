...
class NeuralNetwork:
    ...
    def feedforward(self, scenario):
        ...
        """calling Football.playCall to return a playcall based
        off of the biggestsigmoid calculation from the output layer"""
    ...
    def backprop(self, offense, defense, scenario):
        ...
        for grade in target:
            if grade == 0:
                ...
                targetList.append(.25)
            elif grade == 2:
                targetList.append(.50)
            elif grade == 3:
                targetList.append(.75)
            elif grade == 4:
                targetList.append(1)
    ...
    def input_learn(self):
        ...
        for perceptron in self.input:
            perceptron.epochHI(totalError[index], self.scenario)
            index += 1
